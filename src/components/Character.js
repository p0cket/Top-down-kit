...
const Character = ({ walls, eventSquares, npcs, enemies, onPositionUpdate, onEnemyHealthChange, onSceneChange, movePlayerOnMap }) => {
  ...
  const position = useMovement(walls, eventSquares, npcs, enemies, handleEventTrigger, handleProximity, onPositionUpdate, onEnemyHealthChange);
  useEffect(() => {
